...
use crate::infrastructure::checkpoint_resolver::LoadableCheckpoint;
use crate::infrastructure::model_config::ParallelModelConfig;
...
/// [`crate::infrastructure::checkpoint_resolver`]; this type consumes the
...
impl LanguageModel {
    ...
    pub fn load(
        ...
        match &checkpoint.resolved.layout {
            crate::infrastructure::checkpoint::WeightLayout::Safetensors { files } => {
            ...
            crate::infrastructure::checkpoint::WeightLayout::Gguf { file } => {
            ...
            crate::infrastructure::checkpoint::WeightLayout::Pytorch { file } => {
                let config = read_config(&checkpoint.resolved.config_file, architecture)?;
            ...
            crate::infrastructure::checkpoint::WeightLayout::Numpy { file } => {
                let config = read_config(&checkpoint.resolved.config_file, architecture)?;
...
mod tests {
    ...
    #[test]
    fn manaca_prompt_helpers_are_preserved() {
        assert_eq!(
    ...
    fn batched_suffixes_match_sequential() -> anyhow::Result<()> {
        use crate::infrastructure::checkpoint::ModelReference;
        use crate::infrastructure::checkpoint_resolver::{
            HubCheckpointResolver, LoadableCheckpoint,
        };
        use crate::infrastructure::device::{DeviceResolver, ModelDtype};
    ...
    fn reports_latency_breakdown() -> anyhow::Result<()> {
        use crate::infrastructure::checkpoint::ModelReference;
        use crate::infrastructure::checkpoint_resolver::HubCheckpointResolver;
        use crate::infrastructure::device::{DeviceResolver, ModelDtype};
