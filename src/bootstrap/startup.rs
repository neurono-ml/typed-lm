...
use crate::config::cli::{Cli, Command, ServeArgs, ServerBinding};
use crate::domain::evaluator::Evaluator;
use crate::infrastructure::candle_evaluator::CandleEvaluator;
use crate::infrastructure::checkpoint::{ModelReference, WeightKind};
use crate::infrastructure::checkpoint_resolver::{
    HubCheckpointResolver, LoadableCheckpoint, LocalCheckpointResolver,
};
use crate::infrastructure::context::{ContextProvider, FileContextProvider};
use crate::infrastructure::device::DeviceResolver;
...
fn resolve_checkpoint(serve_arguments: &ServeArgs) -> anyhow::Result<LoadableCheckpoint> {
